...
export default function Footer() {
    ...
    <div className="flex items-center">
        ...
        <a href="//wa.me/" rel="noreferrer" target="_blank">
            <svg className="w-8 h-8 shadow rounded p-1 mx-1 bg-gray-300 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 30 30">
        ...
        <a>
        <svg className="w-8 h-8 shadow rounded p-1.5 mx-1 bg-gray-300 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
    ...
    <a>
      <svg className="w-8 h-8 shadow rounded p-1.5 mx-1 bg-gray-300 text-orange-600" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
